...
@if (session()->has('message'))
    <div class="fw-bold alert @if(session()->has('status') && session('status') == 'fail') alert-danger @else alert-success @endif">
...
@if (session()->has('info'))
    <div class="fw-bold alert @if(session()->has('status') && session('status') == 'fail') alert-danger @else alert-info @endif">
