...
use App\Services\Wncms\Helpers\AnalyticsHelper;
use App\Services\Wncms\Helpers\BannerHelper;
use App\Services\Wncms\Helpers\CacheHelper;
use App\Services\Wncms\Helpers\ContactFormHelper;
use App\Services\Wncms\Helpers\CustomHelper;
use App\Services\Wncms\Helpers\MenuHelper;
use App\Services\Wncms\Helpers\PageHelper;
use App\Services\Wncms\Helpers\PostHelper;
use App\Services\Wncms\Helpers\StarterHelper;
use App\Services\Wncms\Helpers\SettingHelper;
use App\Services\Wncms\Helpers\TagHelper;
use App\Services\Wncms\Helpers\UserHelper;
use App\Services\Wncms\Helpers\WebsiteHelper;
...
if (!function_exists('wncms')) {
    ...
    function wncms()
    {
        return new \App\Services\Wncms\Wncms;
    }
}
