...
namespace Illuminate\Support\Facades {
    ...
    class Auth {
         ...
         *
         * @param mixed $id
         * @return \Wncms\Models\User|false
         * @static
         */
...
namespace Wncms\Facades {
    ...
    class Wncms {
        ...
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->getPackagePath($path);
        }
         ...
         * @static
         */
        public static function getPackageRootPath($path = '')
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->getPackageRootPath($path);
        }
         ...
         * @static
         */
        public static function getVersion($debugType = null)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->getVersion($debugType);
        }
         ...
         * @static
         */
        public static function addVersion($debugType = null)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->addVersion($debugType);
        }
         ...
         * @static
         */
        public static function isActiveUrl($url, $activeClass = 'active', $inActiveClass = null)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->isActiveUrl($url, $activeClass, $inActiveClass);
        }
         ...
         * @static
         */
        public static function isActiveRoutes($routes, $activeClass = 'active', $inActiveClass = null)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->isActiveRoutes($routes, $activeClass, $inActiveClass);
        }
         ...
         * @static
         */
        public static function array_fnmatch($patterns, $path)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->array_fnmatch($patterns, $path);
        }
         ...
         * @static
         */
        public static function getDomainFromString($string, $includePort = true, $preserveWWW = false)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->getDomainFromString($string, $includePort, $preserveWWW);
        }
         ...
         * @static
         */
        public static function isDefaultLocale()
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->isDefaultLocale();
        }
         ...
         * @static
         */
        public static function getRoute($name, $params = [], $isFullPath = true, $domain = null)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->getRoute($name, $params, $isFullPath, $domain);
        }

        /**
         * Paginate collection with limit
         *
         * @param \Illuminate\Pagination\LengthAwarePaginator $collection Collection to paginate
         * @param integer $pageSize Page size
         * @param integer $limit Limit of total items
         * @param integer $currentPage Current page
         * @param string $pageName Page name
         * @return \Illuminate\Pagination\LengthAwarePaginator TODO: Monitor performance
         * @static
         */
        public static function paginateWithLimit($collection, $pageSize = null, $limit = null, $currentPage = null, $pageName = 'page')
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->paginateWithLimit($collection, $pageSize, $limit, $currentPage, $pageName);
        }
         ...
         * @static
         */
        public static function getUniqueSlug($table, $column = 'slug', $length = 8, $case = 'lower', $prefix = '')
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->getUniqueSlug($table, $column, $length, $case, $prefix);
        }
         ...
         * @static
         */
        public static function getAllArgs($func, $func_get_args = [])
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->getAllArgs($func, $func_get_args);
        }

        /**
         * Check if selected
         *
         * @param \Wncms\Services\App/Models/Website $_website
         * @return boolean
         * @static
         */
        public static function isSelectedWebsite($_website)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->isSelectedWebsite($_website);
        }
        ...
        {
            return \Wncms\Services\Wncms::isValidTagifyJson($string);
        }
         ...
         * @return \Wncms\Services\Collection
         * @static
         */
        ...
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->getModelClass($key);
        }
         ...
         * @return \Wncms\Models\Website|\Redirect TODO: Not implemented yet
         * @static
         */
        public static function checkLicense($website)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->checkLicense($website);
        }
         ...
         * @static
         */
        public static function view($name, $params = [], $fallbackView = null, $fallbackRoute = null)
        {
            /** @var \Wncms\Services\Wncms $instance */
            return $instance->view($name, $params, $fallbackView, $fallbackRoute);
        }
    ...
    class PlanManager {
         ...
         * @static
         */
        public static function calculateExpiredAt($price, $from = null)
        {
            /** @var \Wncms\Services\Managers\PlanManager $instance */
            return $instance->calculateExpiredAt($price, $from);
        }

        /**
         * @static
         */
        public static function subscribe($user, $plan, $price)
        {
            /** @var \Wncms\Services\Managers\PlanManager $instance */
            return $instance->subscribe($user, $plan, $price);
        }

        /**
         * @static
         */
        public static function unsubscribe($user, $subscription)
        {
            /** @var \Wncms\Services\Managers\PlanManager $instance */
            return $instance->unsubscribe($user, $subscription);
        }
         ...
         * @static
         */
        public static function canSubscribe($user, $plan, $price)
        {
            /** @var \Wncms\Services\Managers\PlanManager $instance */
            return $instance->canSubscribe($user, $plan, $price);
        }
         ...
         * @static
         */
        public static function update($plan, $data)
        {
            /** @var \Wncms\Services\Managers\PlanManager $instance */
            return $instance->update($plan, $data);
        }
    ...
    class OrderManager {
         ...
         * @static
         */
        public static function create($user, $price, $quantity = 1)
        {
            /** @var \Wncms\Services\Managers\OrderManager $instance */
            return $instance->create($user, $price, $quantity);
        }

        /**
         * @static
         */
        public static function complete($order, $ref_id = null)
        {
            /** @var \Wncms\Services\Managers\OrderManager $instance */
            return $instance->complete($order, $ref_id);
        }
...
namespace  {
    ...
    class Wncms extends \Wncms\Facades\Wncms {}
    class PlanManger extends \Wncms\Facades\PlanManager {}
    class OrderManager extends \Wncms\Facades\OrderManager {}
}
